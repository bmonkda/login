...
-->                
                ...
                @if (auth()->user()->hasRole('Admin'))
                    ...
                    <div class="form-group">
                        ...
                        {{-- {!! Form::label('idempleado', 'Asignado a:') !!}
                        ...
                        {{-- {!! Form::select('idempleado', $users2, null, ['class' => 'form-control', 'id' => 'idempleado', 'placeholder' => 'Selecione una opción']) !!} --}}
        ...
        $(document).ready(function() {
            $('#category_id').on('change', function(){
				if($('#category_id').val() == ""){
					...
					$('<option value = "">Selecciona una subcategoría</option>').appendTo('#subcategory_id');
					$('#subcategory_id').attr('disabled', 'disabled');
				}else{
					$('#subcategory_id').removeAttr('disabled', 'disabled');
					$('#subcategory_id').load('subcategory_id_get.php?category_id=' + $('#category_id').val());
				}
            });
        });
